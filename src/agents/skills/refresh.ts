...
function resolveWatchPaths(workspaceDir: string, config?: AlisioConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AlisioConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AlisioConfig }) {
