...
export function resolveSubagentToolPolicy(cfg?: AlisioConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: AlisioConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: AlisioConfig["tools"];
