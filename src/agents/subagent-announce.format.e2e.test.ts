...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/alisio/alisio/issues/31298
    previousFastTestEnv = process.env.ALISIO_TEST_FAST;
  ...
  afterAll(() => {
    ...
    if (previousFastTestEnv === undefined) {
      delete process.env.ALISIO_TEST_FAST;
      return;
    }
    process.env.ALISIO_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // ALISIO_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("Alisio runtime context (internal):");
