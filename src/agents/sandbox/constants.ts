...
export const DEFAULT_SANDBOX_IMAGE = "alisio-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "alisio-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "alisio-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "alisio-sandbox-common:bookworm-slim";
