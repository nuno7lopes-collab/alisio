...
const CLEANUP_STATE_KEY = Symbol.for("alisio.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("alisio.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("alisio.sessionWriteLockWatchdogState");
