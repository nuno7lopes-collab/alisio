...
export function buildSubagentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "",
    "## Output Format",
    "When complete, return a short structured handoff with these fields:",
    "- Status: completed | blocked | failed",
    "- Summary: what you accomplished or found",
    `- Details: only the key facts the ${parentLabel} should know`,
    "- Next: follow-up needed, or none",
    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            "Do not use `exec` (`alisio ...`, `acpx ...`) to spawn ACP sessions.",
