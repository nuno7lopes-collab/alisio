...
function resolveAdaptiveReadMaxBytes(options?: AlisioReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAlisioReadTool(base, {
...
export function createAlisioReadTool(
  base: AnyAgentTool,
  options?: AlisioReadToolOptions,
): AnyAgentTool {
