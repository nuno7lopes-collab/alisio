...
const makeConfig = (opts?: { fallbacks?: string[]; apiKey?: string }): AlisioConfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeAgentOverrideOnlyFallbackConfig = (agentId: string): AlisioConfig =>
  ({
    agents: {
      defaults: {
        model: {
...
const makeCopilotConfig = (): AlisioConfig =>
  ({
    models: {
      providers: {
        "github-copilot": {
