...
export function isCliProvider(provider: string, cfg?: AlisioConfig): boolean {
...
export function buildConfiguredModelCatalog(params: { cfg: AlisioConfig }): ModelCatalogEntry[] {
