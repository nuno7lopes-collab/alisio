...
async function resolveContext(config: AlisioConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): AlisioConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
