...
function resolveAnthropicOpusThinking(cfg: AlisioConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<AlisioConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<AlisioConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<AlisioConfig> = {
        agents: {
          defaults: {
            models: {
