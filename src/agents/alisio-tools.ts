...
const defaultAlisioToolsDeps: AlisioToolsDeps = {
  callGateway,
};
...
export function createAlisioTools(
  ...
  const resolvedConfig = options?.config ?? alisioToolsDeps.config;
  ...
  const tools: AnyAgentTool[] = [
    ...
    createSessionsListTool({
      ...
      sandboxed: options?.sandboxed,
      config: resolvedConfig,
      callGateway: alisioToolsDeps.callGateway,
    }),
...
export const __testing = {
  setDepsForTest(overrides?: Partial<AlisioToolsDeps>) {
    alisioToolsDeps = overrides
      ? {
          ...defaultAlisioToolsDeps,
          ...overrides,
        }
      : defaultAlisioToolsDeps;
  },
