...
describe("method scope resolution", () => {
  it.each([
    ...
    ["sessions.runtime.reset", ["operator.admin"]],
    ["tasks.proposal.upsert", ["operator.write"]],
    ["tasks.proposal.resolve", ["operator.write"]],
    ["tasks.launchFromProposal", ["operator.write"]],
...
describe("operator scope authorization", () => {
  it.each([
    ...
    ["memory.e2ee.setup", ["operator.write"], { allowed: true }],
    ["memory.e2ee.exportPairingCode", ["operator.write"], { allowed: true }],
    ["memory.e2ee.importPairingCode", ["operator.write"], { allowed: true }],
    ...
    ["tasks.launchFromProposal", ["operator.write"], { allowed: true }],
...
describe("plugin approval method registration", () => {
  ...
  it("classifies plugin approval methods", () => {
    ...
    expect(isGatewayMethodClassified("tasks.launchFromProposal")).toBe(true);
