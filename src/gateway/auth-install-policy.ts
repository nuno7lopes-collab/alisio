...
type GatewayInstallAuthMode = NonNullable<NonNullable<AlisioConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: AlisioConfig): boolean {
