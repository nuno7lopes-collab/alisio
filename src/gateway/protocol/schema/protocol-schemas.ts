...
export const ProtocolSchemas = {
  ...
  AlisioConnectorSurface: AlisioConnectorSurfaceSchema,
  ...
  AlisioProviderOverviewUsageWindow: AlisioProviderOverviewUsageWindowSchema,
  AlisioProviderOverviewItem: AlisioProviderOverviewItemSchema,
  AlisioProviderOverviewSummary: AlisioProviderOverviewSummarySchema,
  AlisioProvidersGetParams: AlisioProvidersGetParamsSchema,
  AlisioProvidersResult: AlisioProvidersResultSchema,
  AlisioAppRebuildParams: AlisioAppRebuildParamsSchema,
  AlisioAppRebuildResult: AlisioAppRebuildResultSchema,
  ...
  AlisioAccountEmailChangeParams: AlisioAccountEmailChangeParamsSchema,
  AlisioAccountEmailChangeResult: AlisioAccountEmailChangeResultSchema,
  ...
  AlisioAccountGoogleAuthCompleteParams: AlisioAccountGoogleAuthCompleteParamsSchema,
  AlisioAccountPasswordUpdateParams: AlisioAccountPasswordUpdateParamsSchema,
  AlisioAccountPasswordUpdateResult: AlisioAccountPasswordUpdateResultSchema,
  ...
  AlisioConnectorsRevokeResult: AlisioConnectorsRevokeResultSchema,
  ...
  SessionsRuntimeResetParams: SessionsRuntimeResetParamsSchema,
  ...
  CanonicalTaskStatus: CanonicalTaskStatusSchema,
  Task: TaskSchema,
  TaskExecution: TaskExecutionSchema,
  TaskExecutionKind: TaskExecutionKindSchema,
  TaskExecutionStatus: TaskExecutionStatusSchema,
  TaskAssignment: TaskAssignmentSchema,
  TaskAssignmentStatus: TaskAssignmentStatusSchema,
  TaskApproval: TaskApprovalSchema,
  TaskApprovalStatus: TaskApprovalStatusSchema,
  TaskEvent: TaskEventSchema,
  TaskEventKindV2: TaskEventKindV2Schema,
  TaskDependency: TaskDependencySchema,
  TaskDependencyKind: TaskDependencyKindSchema,
  TaskRuntime: TaskRuntimeSchema,
  TaskStatus: TaskStatusSchema,
  TaskDeliveryStatus: TaskDeliveryStatusSchema,
  TaskNotifyPolicy: TaskNotifyPolicySchema,
  TaskTerminalOutcome: TaskTerminalOutcomeSchema,
  TaskProposalKind: TaskProposalKindSchema,
  TaskProposalDecision: TaskProposalDecisionSchema,
  TaskProposalCreatedBy: TaskProposalCreatedBySchema,
  TaskStatusCounts: TaskStatusCountsSchema,
  TaskRuntimeCounts: TaskRuntimeCountsSchema,
  TaskRegistrySummary: TaskRegistrySummarySchema,
  TaskProposalSummary: TaskProposalSummarySchema,
  CanonicalTaskSummary: CanonicalTaskSummarySchema,
  TaskRecord: TaskRecordSchema,
  TaskProposalRecord: TaskProposalRecordSchema,
  TaskAuditFinding: TaskAuditFindingSchema,
  TaskAuditSummary: TaskAuditSummarySchema,
  TaskMaintenanceSummary: TaskMaintenanceSummarySchema,
  TasksOverviewParams: TasksOverviewParamsSchema,
  TasksOverviewResult: TasksOverviewResultSchema,
  TasksDetailParams: TasksDetailParamsSchema,
  TasksDetailResult: TasksDetailResultSchema,
  ...
  TasksClaimParams: TasksClaimParamsSchema,
  TasksClaimResult: TasksClaimResultSchema,
  TasksReleaseParams: TasksReleaseParamsSchema,
  TasksReleaseResult: TasksReleaseResultSchema,
  TasksSpawnChildParams: TasksSpawnChildParamsSchema,
  TasksSpawnChildResult: TasksSpawnChildResultSchema,
  TasksExecutionStartParams: TasksExecutionStartParamsSchema,
  TasksExecutionStartResult: TasksExecutionStartResultSchema,
  TasksExecutionEndParams: TasksExecutionEndParamsSchema,
  TasksExecutionEndResult: TasksExecutionEndResultSchema,
  TasksExecutionCancelParams: TasksExecutionCancelParamsSchema,
  TasksExecutionCancelResult: TasksExecutionCancelResultSchema,
  TasksApprovalRequestParams: TasksApprovalRequestParamsSchema,
  TasksApprovalRequestResult: TasksApprovalRequestResultSchema,
  TasksApprovalDecideParams: TasksApprovalDecideParamsSchema,
  TasksApprovalDecideResult: TasksApprovalDecideResultSchema,
  TasksCancelParams: TasksCancelParamsSchema,
  TasksCancelResult: TasksCancelResultSchema,
  TasksNotifyParams: TasksNotifyParamsSchema,
  TasksNotifyResult: TasksNotifyResultSchema,
  TasksLaunchFromProposalParams: TasksLaunchFromProposalParamsSchema,
  TasksLaunchFromProposalResult: TasksLaunchFromProposalResultSchema,
  TasksProposalUpsertParams: TasksProposalUpsertParamsSchema,
  TasksProposalUpsertResult: TasksProposalUpsertResultSchema,
  TasksProposalResolveParams: TasksProposalResolveParamsSchema,
  TasksProposalResolveResult: TasksProposalResolveResultSchema,
  TasksProposalAttachLaunchParams: TasksProposalAttachLaunchParamsSchema,
  TasksProposalAttachLaunchResult: TasksProposalAttachLaunchResultSchema,
  ...
  MemoryGraphBranch: MemoryGraphBranchSchema,
  MemoryGraphEdge: MemoryGraphEdgeSchema,
  MemoryGraphEdgeReason: MemoryGraphEdgeReasonSchema,
  MemoryGraphFocus: MemoryGraphFocusSchema,
  MemoryGraphMatch: MemoryGraphMatchSchema,
  MemoryGraphMatchRelation: MemoryGraphMatchRelationSchema,
  MemoryGraphNode: MemoryGraphNodeSchema,
  MemoryGraphParams: MemoryGraphParamsSchema,
  MemoryGraphProjection: MemoryGraphProjectionSchema,
  MemoryGraphRelatedEntity: MemoryGraphRelatedEntitySchema,
  MemoryGraphResult: MemoryGraphResultSchema,
  MemoryGraphStats: MemoryGraphStatsSchema,
  MemoryGraphTruncated: MemoryGraphTruncatedSchema,
  ...
  MemoryE2eeSetupParams: MemoryE2eeSetupParamsSchema,
  MemoryE2eeSetupResult: MemoryE2eeSetupResultSchema,
  MemoryE2eeExportPairingCodeParams: MemoryE2eeExportPairingCodeParamsSchema,
  MemoryE2eeExportPairingCodeResult: MemoryE2eeExportPairingCodeResultSchema,
  MemoryE2eeImportPairingCodeParams: MemoryE2eeImportPairingCodeParamsSchema,
  MemoryE2eeImportPairingCodeResult: MemoryE2eeImportPairingCodeResultSchema,
  ...
  DevicesListParams: DevicesListParamsSchema,
  DevicesListResult: DevicesListResultSchema,
  DevicesShareRequestParams: DevicesShareRequestParamsSchema,
  DevicesShareRequestResult: DevicesShareRequestResultSchema,
  DevicesShareApproveParams: DevicesShareApproveParamsSchema,
  DevicesShareApproveResult: DevicesShareApproveResultSchema,
  DevicesShareRevokeParams: DevicesShareRevokeParamsSchema,
  DevicesShareRevokeResult: DevicesShareRevokeResultSchema,
  DevicesPolicySetParams: DevicesPolicySetParamsSchema,
  DevicesPolicySetResult: DevicesPolicySetResultSchema,
