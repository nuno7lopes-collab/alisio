...
export function resolveHooksConfig(cfg: AlisioConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: AlisioConfig, defaultAgentId: string): Set<string> {
