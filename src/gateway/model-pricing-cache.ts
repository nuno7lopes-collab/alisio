...
export function collectConfiguredModelPricingRefs(config: AlisioConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: AlisioConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
