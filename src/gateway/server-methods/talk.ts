...
import type { AlisioConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
...
function buildTalkTtsConfig(
  config: AlisioConfig,
): { cfg: AlisioConfig; provider: string; providerConfig: TalkProviderConfig } | { error: string } {
