...
import type { ConfigFileSnapshot, AlisioConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => AlisioConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: AlisioConfig }): ConfigFileSnapshot {
  return {
