...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): AlisioConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: AlisioConfig, env: NodeJS.ProcessEnv) =>
