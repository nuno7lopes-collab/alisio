...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.e2ee": "Memory E2EE",
  "memory.e2ee.required": "Memory E2EE Required",
  "memory.sync": "Memory Sync",
  "memory.sync.mode": "Memory Sync Mode",
  ...
  "memory.jobs.enabled": "Enable Memory Jobs",
  "memory.jobs.maxSliceMs": "Memory Job Slice Budget (ms)",
  "memory.jobs.autoSleep": "Memory Job Auto Sleep",
  "memory.jobs.autoSleep.enabled": "Enable Memory Job Auto Sleep",
  ...
  "plugins.installs.*.marketplaceRegistryUrl": "Plugin Marketplace Registry URL",
  "plugins.installs.*.marketplacePackage": "Plugin Marketplace Package",
  "plugins.installs.*.marketplaceFamily": "Plugin Marketplace Family",
  "plugins.installs.*.marketplaceChannel": "Plugin Marketplace Channel",
