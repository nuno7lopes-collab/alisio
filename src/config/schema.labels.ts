...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "memory.obsidianReadOnly": "Obsidian Read-only Connector",
  "memory.obsidianReadOnly.enabled": "Enable Obsidian Read-only Connector",
  "memory.obsidianReadOnly.vaultPath": "Obsidian Read-only Vault Path",
