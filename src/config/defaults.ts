...
function resolveAnthropicDefaultAuthMode(cfg: AlisioConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AlisioConfig): AlisioConfig {
...
export function applyTalkApiKey(config: AlisioConfig): AlisioConfig {
...
export function applyTalkConfigNormalization(config: AlisioConfig): AlisioConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: AlisioConfig): AlisioConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AlisioConfig): AlisioConfig {
...
export function applyLoggingDefaults(cfg: AlisioConfig): AlisioConfig {
...
export function applyContextPruningDefaults(cfg: AlisioConfig): AlisioConfig {
...
export function applyCompactionDefaults(cfg: AlisioConfig): AlisioConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
