...
export type AlisioConfig = {
  meta?: {
    /** Last Alisio version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Alisio UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const alisioConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = AlisioConfig & {
  readonly [alisioConfigStateBrand]?: TState;
};
