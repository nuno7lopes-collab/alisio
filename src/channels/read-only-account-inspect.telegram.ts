...
function resolveDefaultTelegramAccountId(cfg: AlisioConfig): string {
...
function mergeTelegramAccountConfig(cfg: AlisioConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
