...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: AlisioConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: AlisioConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: AlisioConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: AlisioConfig; accountId?: string | null }) => number | undefined;
