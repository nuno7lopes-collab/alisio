...
export function listChannelMessageActions(cfg: AlisioConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: AlisioConfig): ChannelMessageCapability[] {
