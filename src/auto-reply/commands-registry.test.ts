...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@alisio", { botUsername: "alisio" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@alisio args", {
        botUsername: "alisio",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "alisio" })).toBe(
      "/help@otherbot",
    );
  });
