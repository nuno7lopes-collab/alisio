...
function resolveAcpStreamCoalesceIdleMs(cfg: AlisioConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AlisioConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AlisioConfig): AcpProjectionSettings {
