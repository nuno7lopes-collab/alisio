...
function resolveMentionPatterns(cfg: AlisioConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AlisioConfig | undefined, agentId?: string): RegExp[] {
