...
export function listAuthProfileStorePaths(config: AlisioConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: AlisioConfig, stateDir: string): string[] {
