...
function resolveResolutionLimits(config: AlisioConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AlisioConfig): SecretProviderConfig {
