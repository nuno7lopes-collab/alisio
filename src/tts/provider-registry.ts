...
function resolveSpeechProviderPluginEntries(cfg?: AlisioConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: AlisioConfig): SpeechProviderPlugin[] {
