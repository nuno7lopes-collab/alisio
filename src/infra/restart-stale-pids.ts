 ...
 * returning control to the caller (typically `triggerAlisioRestart` →
...
/**
 * Parse gateway PIDs from lsof -Fpc stdout.
 ...
 * Returns only PIDs that belong to gateway processes (not the current process).
 */
