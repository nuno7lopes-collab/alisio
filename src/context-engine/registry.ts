...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("alisio.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("alisio.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: AlisioConfig): Promise<ContextEngine> {
