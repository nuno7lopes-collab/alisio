...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile("imessage", "runtime-api.ts")]: [
    'export { DEFAULT_ACCOUNT_ID, buildChannelConfigSchema, getChatChannelMeta, type ChannelPlugin, type AlisioConfig } from "alisio/plugin-sdk/core";',
  ...
  [bundledPluginFile("matrix", "runtime-api.ts")]: [
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, AlisioConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "alisio/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile("telegram", "runtime-api.ts")]: [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, AlisioConfig, AlisioPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "alisio/plugin-sdk/telegram-core";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { AlisioPluginService, AlisioPluginServiceContext, PluginLogger } from "alisio/plugin-sdk/core";',
