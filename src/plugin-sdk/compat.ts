// Deprecated compat surface for external plugins that still depend on older
// broad plugin-sdk imports. Keep this file intentionally small.

const shouldWarnCompatImport =
  process.env.VITEST !== "true" &&
  process.env.NODE_ENV !== "test" &&
  process.env.ALISIO_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "alisio/plugin-sdk/compat is deprecated for new plugins. Migrate to focused alisio/plugin-sdk/<subpath> imports. See https://docs.alisio.ai/plugins/sdk-migration",
    {
      code: "ALISIO_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.alisio.ai/plugins/sdk-migration",
    },
  );
}
