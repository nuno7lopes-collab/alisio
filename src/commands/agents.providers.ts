...
function resolveDefaultAccountId(cfg: AlisioConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AlisioConfig): boolean {
...
export function summarizeBindings(cfg: AlisioConfig, bindings: AgentBinding[]): string[] {
