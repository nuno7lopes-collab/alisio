...
import { replaceConfigFile, type AlisioConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: AlisioConfig | null) {
...
export async function channelsAddCommand(
  ...
  const cfg = (configSnapshot.sourceConfig ?? configSnapshot.config) as AlisioConfig;
  ...
  // May trigger loadAlisioPlugins on cache miss (disk scan + jiti import)
