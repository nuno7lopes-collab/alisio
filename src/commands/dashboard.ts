...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set ALISIO_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `alisio dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Alisio.");
  } else if (hint) {
    runtime.log(hint);
  }
}
