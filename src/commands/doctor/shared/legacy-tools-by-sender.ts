...
export function scanLegacyToolsBySenderKeys(cfg: AlisioConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AlisioConfig): {
  config: AlisioConfig;
  changes: string[];
} {
