...
export function collectMissingDefaultAccountBindingWarnings(cfg: AlisioConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: AlisioConfig): string[] {
  const warnings: string[] = [];
