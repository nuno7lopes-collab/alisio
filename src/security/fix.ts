...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AlisioConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AlisioConfig; env: NodeJS.ProcessEnv }): {
  cfg: AlisioConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
