...
export function isAcpEnabledByPolicy(cfg: AlisioConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AlisioConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AlisioConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AlisioConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AlisioConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: AlisioConfig, agentId: string): boolean {
