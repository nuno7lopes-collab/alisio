const DEFAULT_TAGLINE = "All your chats, one Alisio.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little shell-side assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just gained a lobster copilot—type something and let the bot handle the busywork.",
  ...
  "Automation with shell discipline: minimal fuss, maximal throughput.",
  ...
  "Commit in, diff clean—let's ship something mildly responsible.",
  ...
  "You had me at 'alisio gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ALISIO_TAGLINE_INDEX;
