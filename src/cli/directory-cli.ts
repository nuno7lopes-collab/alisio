    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["alisio directory self --channel slack", "Show the connected account identity."],
          [
            'alisio directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["alisio directory groups list --channel discord", "List available groups/channels."],
          [
            "alisio directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.alisio.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
