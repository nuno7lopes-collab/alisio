...
export function applyProviderDefaultModel(cfg: AlisioConfig, modelRef: string): AlisioConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: AlisioConfig; modelId: string; modelRef: string; profileId: string } {
