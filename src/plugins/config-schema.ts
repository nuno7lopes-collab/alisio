...
import type { PluginConfigUiHint, AlisioPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: AlisioPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): AlisioPluginConfigSchema {
  return {
