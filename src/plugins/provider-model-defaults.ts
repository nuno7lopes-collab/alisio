...
export function applyGoogleGeminiModelDefault(cfg: AlisioConfig): {
  next: AlisioConfig;
  changed: boolean;
} {
...
export function applyOpencodeGoModelDefault(cfg: AlisioConfig): {
  next: AlisioConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: AlisioConfig): {
  next: AlisioConfig;
  changed: boolean;
} {
