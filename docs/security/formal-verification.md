...
summary: Machine-checked security models for Alisio’s highest-risk paths.
read_when:
...
This page tracks Alisio’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Alisio enforces its
...
**What this is not (yet):** a proof that “Alisio is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/alisio-formal-models](https://github.com/vignesh07/alisio-formal-models).
...
```bash
git clone https://github.com/vignesh07/alisio-formal-models
cd alisio-formal-models
