...
# Remote Gateway
openclaw acp --url wss://gateway-host:40705 --token <token>
...
openclaw acp client --server-args --url wss://gateway-host:40705 --token <token>
...
```bash
openclaw config set gateway.remote.url wss://gateway-host:40705
