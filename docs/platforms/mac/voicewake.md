...
- Replies are delivered to the **last-used main provider** (WhatsApp/Telegram/Discord or another configured main channel). If delivery fails, the error is logged and the run is still visible in the native macOS workspace and session logs.
