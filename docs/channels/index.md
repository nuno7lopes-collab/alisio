---
summary: "Messaging platforms Alisio can connect to"
read_when:
  - You want to choose a chat channel for Alisio
...
- Channels can run simultaneously; configure multiple and Alisio will route per chat.
