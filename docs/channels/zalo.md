...
- Install via CLI: `alisio plugins install @alisio/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `alisio plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `alisio plugins install @alisio/zalo`
...
This page reflects current Alisio behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `alisio pairing list zalo`
  - `alisio pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Alisio.
...
- Example: `alisio message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `alisio channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `alisio logs --follow`
