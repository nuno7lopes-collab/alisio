...
summary: "Testing utilities and patterns for Alisio plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Alisio
plugins.
...
**Import:** `alisio/plugin-sdk/testing`
...
import type { PluginRuntime } from "alisio/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `alisio/plugin-sdk` root barrel is rejected
...
Alisio uses Vitest with V8 coverage thresholds. For plugin tests:
