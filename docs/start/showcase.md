...
<Card title="Home Assistant Add-on" icon="home" href="https://github.com/ngutman/alisio-ha-addon">
...
<Card title="Nix Packaging" icon="snowflake" href="https://github.com/alisio/nix-alisio">
  **@alisio** • `nix` `packaging` `deployment`
