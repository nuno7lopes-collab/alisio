---
summary: "Alisio tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Alisio provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Alisio), others are **external**
...
| `group:nodes`      | nodes                                                                                                     |
| `group:alisio`     | All built-in Alisio tools (excludes plugin tools)                                                         |
