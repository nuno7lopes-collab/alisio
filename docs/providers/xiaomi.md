---
summary: "Use Xiaomi MiMo models with Alisio"
read_when:
  - You want Xiaomi MiMo models in Alisio
...
Xiaomi MiMo is the API platform for **MiMo** models. Alisio uses the Xiaomi
...
```bash
alisio onboard --auth-choice xiaomi-api-key
# or non-interactive
alisio onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
