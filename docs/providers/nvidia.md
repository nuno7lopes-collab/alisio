---
summary: "Use NVIDIA's OpenAI-compatible API in Alisio"
read_when:
  - You want to use NVIDIA models in Alisio
...
alisio onboard --auth-choice skip
alisio models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
