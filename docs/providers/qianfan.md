---
summary: "Use Qianfan's unified API to access many models in Alisio"
read_when:
...
3. Alisio installed on your system
...
4. Copy the API key for use with Alisio

## CLI setup

```bash
alisio onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Alisio Configuration](/gateway/configuration)
