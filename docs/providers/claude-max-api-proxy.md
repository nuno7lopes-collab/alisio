...
You can point Alisio at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Alisio
...
- [Anthropic provider](/providers/anthropic) - Native Alisio integration with Claude setup-token or API keys
