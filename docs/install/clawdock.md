---
summary: "ClawDock shell helpers for Docker-based Alisio installs"
read_when:
...
ClawDock is a small shell-helper layer for Docker-based Alisio installs.
...
| `clawdock-cli <command>`  | Run Alisio CLI commands in Docker             |
