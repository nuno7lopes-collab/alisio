...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AlisioPhotosLatestParams) async throws -> AlisioPhotosLatestPayload {
        ...
        var results: [AlisioPhotoPayload] = []
        ...
        return AlisioPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AlisioPhotoPayload
    {
