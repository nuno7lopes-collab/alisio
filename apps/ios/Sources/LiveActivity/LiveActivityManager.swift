...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.alisio.ios", category: "LiveActivity")
    private var currentActivity: Activity<AlisioActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AlisioActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AlisioActivityAttributes>.activities
    ...
    private func updateCurrent(state: AlisioActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AlisioActivityAttributes.ContentState {
        AlisioActivityAttributes.ContentState(
    ...
    private func idleState() -> AlisioActivityAttributes.ContentState {
        AlisioActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AlisioActivityAttributes.ContentState {
        AlisioActivityAttributes.ContentState(
