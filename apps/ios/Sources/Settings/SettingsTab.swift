...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AlisioLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.alisio.ios", category: "GatewaySettings")
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Alisio agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Alisio agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Alisio. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Alisio is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Alisio", value: DeviceInfoHelper.alisioVersionString())
                    }
                }
            }
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Alisio chat and run /pair approve, then tap Connect again."
        }
