    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          Text("Alisio Android ${alisioAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text("Copy Report for Support", style = mobileCallout.copy(fontWeight = FontWeight.Bold))
          }
        }
      }
    }
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("alisio qr --setup-code-only")
          CommandBlock("alisio qr --json")
