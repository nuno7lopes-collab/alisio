...
import ai.alisio.app.ui.mobileSurface
import ai.alisio.app.ui.mobileText
import ai.alisio.app.ui.mobileTextSecondary
import ai.alisio.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.alisio.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.alisio.app.ui.mobileFontFamily,
