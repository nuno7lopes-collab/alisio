...
public enum AlisioCanvasA2UICommand: String, Codable, Sendable {
...
public struct AlisioCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AlisioCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
