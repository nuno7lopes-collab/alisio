...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AlisioProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AlisioProtocol.AnyCodable(identity.deviceId),
            "publicKey": AlisioProtocol.AnyCodable(publicKey),
            "signature": AlisioProtocol.AnyCodable(signature),
            "signedAt": AlisioProtocol.AnyCodable(signedAtMs),
            "nonce": AlisioProtocol.AnyCodable(nonce),
        ]
    }
}
