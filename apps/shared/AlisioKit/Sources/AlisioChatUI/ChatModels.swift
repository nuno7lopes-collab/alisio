...
public typealias AlisioPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias AlisioPlatformImage = UIImage
#endif

public struct AlisioChatUsageCost: Codable, Hashable, Sendable {
...
public struct AlisioChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: AlisioChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(AlisioChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct AlisioChatMessageContent: Codable, Hashable, Sendable {
...
public struct AlisioChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [AlisioChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: AlisioChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [AlisioChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: AlisioChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(AlisioChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([AlisioChatMessageContent].self, forKey: .content) {
...
public struct AlisioChatHistoryPayload: Codable, Sendable {
...
public struct AlisioSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct AlisioSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [AlisioSessionPreviewItem]
}

public struct AlisioSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [AlisioSessionPreviewEntry]

    public init(ts: Int, previews: [AlisioSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct AlisioChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct AlisioChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct AlisioAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct AlisioChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct AlisioGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct AlisioPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: AlisioPlatformImage?
...
public struct AlisioChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
