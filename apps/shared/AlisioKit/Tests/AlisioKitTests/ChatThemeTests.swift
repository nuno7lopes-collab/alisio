...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = AlisioChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = AlisioChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
