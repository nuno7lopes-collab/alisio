...
struct DebugSettings: View {
    ...
    private func loadSessionStorePath() {
        let parsed = AlisioConfigFile.loadDict()
        guard
...
extension DebugSettings {
    static func exerciseForTesting() async {
        ...
        view.gatewayRootInput = "/tmp/alisio"
