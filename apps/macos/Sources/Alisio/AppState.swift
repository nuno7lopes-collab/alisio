...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = AlisioConfigFile.loadDict()
        ...
        remoteTokenDirty: Bool) -> (remote: [String: Any], changed: Bool)
    {
        ...
        case .ssh:
            ...
            if let host = remoteHost {
                ...
                let port = parsedExisting?.port ?? GatewayDefaults.defaultPort
    ...
    private func startConfigWatcher() {
        let configUrl = AlisioConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: AlisioConfigFile.loadDict(),
        ...
        AlisioConfigFile.saveDict(synced.root)
    }
