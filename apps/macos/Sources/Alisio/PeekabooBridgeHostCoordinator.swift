...
final class PeekabooBridgeHostCoordinator {
    ...
    private static var alisioSocketPath: String {
        ...
        return Self.makeSocketPath(for: "Alisio", in: base)
    }
    ...
    private func startIfNeeded() async {
        ...
        let host = PeekabooBridgeHost(
            socketPath: Self.alisioSocketPath,
            server: server,
...
@MainActor
private final class AlisioPeekabooBridgeServices: PeekabooBridgeServiceProviding {
