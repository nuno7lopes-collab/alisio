...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/alisio/alisio") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "Source Code",
                    url: "https://github.com/alisio/alisio")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AlisioBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AlisioBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AlisioGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AlisioGitCommit") as? String) ??
            "unknown"
    }
