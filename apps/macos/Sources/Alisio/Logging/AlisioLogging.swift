...
enum AlisioLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = AlisioOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = AlisioFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        ...
        let label = AlisioLogging.makeLabel(subsystem: subsystem, category: category)
...
struct AlisioOSLogHandler: AppLogLevelBackedHandler {
...
struct AlisioFileLogHandler: AppLogLevelBackedHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = AlisioLogging.parseLabel(self.label)
