...
enum ExecApprovalsStore {
    ...
    static func fileURL() -> URL {
        AlisioPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        AlisioPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
    ...
    private static func ensureSecureStateDirectory() {
        let url = AlisioPaths.stateDirURL
        do {
