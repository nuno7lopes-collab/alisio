...
enum LumeThemeChoice: String, CaseIterable, Identifiable {
    case dark
    case light
    case system
...
enum LumeLanguageChoice: String, CaseIterable, Identifiable {
    case english
    case portuguese
    case spanish
...
struct LumePalette {
    ...
    static func resolve(theme: LumeThemeChoice, systemScheme: ColorScheme) -> LumePalette {
...
struct LumePanel<Content: View>: View {
...
struct LumeBrandMark: View {
    ...
    init(palette: LumePalette, size: CGFloat = 34) {
        self.palette = palette
        self.size = size
    }
...
struct LumeGhostButtonStyle: ButtonStyle {
    let palette: LumePalette
    let isDanger: Bool

    init(palette: LumePalette, isDanger: Bool = false) {
        self.palette = palette
...
struct LumePrimaryButtonStyle: ButtonStyle {
    ...
    init(palette: LumePalette, tint: Color? = nil) {
        self.palette = palette
        self.tint = tint
    }
