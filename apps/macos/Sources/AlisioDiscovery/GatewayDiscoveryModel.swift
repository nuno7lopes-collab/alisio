...
public final class GatewayDiscoveryModel {
    ...
    public func start() {
        ...
        for domain in AlisioBonjour.gatewayServiceDomains {
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = AlisioBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = AlisioBonjour.wideAreaGatewayServiceDomain,
    ...
    private var hasUsableWideAreaResults: Bool {
        guard let domain = AlisioBonjour.wideAreaGatewayServiceDomain else { return false }
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized
            .replacingOccurrences(of: " (Alisio)", with: "")
            .replacingOccurrences(of: " (Alisio)", with: "")
