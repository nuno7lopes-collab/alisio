  ...
  alisio: {
    ...
    settings: {
      ...
      models: {
        title: "Modelos",
        subtitle:
          "Gestiona cuentas de OpenAI, modelos locales y endpoints alternativos desde un solo lugar.",
        chatgptTitle: "OpenAI Codex",
        chatgptSubtitle: "Cuentas y elecciones de modelo disponibles en este ordenador.",
        localTitle: "Local",
        localSubtitle: "Modelos instalados y recomendados en este u otro ordenador vinculado.",
        serversTitle: "OpenAI Alt",
        serversSubtitle:
          "Tu endpoint compatible con OpenAI u Ollama cuando necesites otro runtime.",
        ...
        runtimeNotConfigured: "El runtime local todavía no está configurado",
