  ...
  alisio: {
    ...
    settings: {
      ...
      models: {
        title: "Modelos",
        subtitle:
          "Gestiona OpenAI, modelos locales en este ordenador y fuentes remotas desde un solo lugar.",
        chatgptTitle: "OpenAI",
        chatgptSubtitle: "Perfiles y modelos disponibles para el chat en este ordenador.",
        localTitle: "Local",
        localSubtitle: "Modelos instalados y recomendados que corren en este ordenador.",
        serversTitle: "Servidor",
        serversSubtitle:
          "Otros ordenadores vinculados y endpoints remotos cuando quieras ejecutar modelos fuera de aquí.",
        currentComputer: "Este ordenador",
        linkedComputer: "Ordenador vinculado",
        linkedComputerShort: "ordenador vinculado",
        linkedComputersShort: "ordenadores vinculados",
        ...
        serverDraftAddTitle: "Añadir endpoint",
        ...
        serverNamePrompt: "Ponle un nombre a este servidor",
        serverKindPrompt: "Tipo de servidor: openai-compatible u ollama",
        serverUrlPrompt: "Dirección base del servidor",
        serverKeyPrompt: "Clave API opcional. Déjala vacía para mantener la actual.",
        serverActive: "Activo",
        serverApiKeySaved: "Clave API guardada",
        serverReady: "Listo",
        serverError: "Error",
        linkedComputersTitle: "Ordenadores vinculados",
        linkedComputersSubtitle:
          "Modelos y runtimes disponibles en tus otros ordenadores conectados.",
        endpointsTitle: "Endpoints",
        endpointsSubtitle: "Servidores OpenAI-compatible u Ollama añadidos manualmente.",
