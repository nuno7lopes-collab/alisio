...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    authentications: "Connected accounts and runtime access.",
    organization: "Workspace systems, channels, and delivery health.",
    sessions: "Active sessions and defaults.",
    automations: "Wakeups and recurring runs.",
    chat: "Gateway chat for quick interventions.",
    settings: "Workspace configuration, shell controls, and diagnostics.",
  },
  overview: {
    access: {
