...
export const en: TranslationMap = {
  ...
  alisio: {
    ...
    channels: {
      ...
      setupSavedQr: "Channel saved. Finish the WhatsApp link with the QR code.",
      stepsTitle: "3 steps",
      steps: {
        telegram: {
    ...
    settings: {
      ...
      models: {
        title: "Models",
        subtitle: "Manage ChatGPT, local models, and future server endpoints from one place.",
        chatgptTitle: "ChatGPT",
        chatgptSubtitle: "Accounts available on this computer.",
        localTitle: "Local models",
        localSubtitle: "Runs through a local runtime on this or another linked computer.",
        serversTitle: "Servers",
        serversSubtitle: "Bring your own model server when you want a dedicated machine.",
    ...
    connections: {
      eyebrow: "Runtime",
      title: "Connections",
      subtitle: "Devices, live nodes, execution bindings, and runtime connectivity.",
      refreshing: "Refreshing…",
      ...
      bindings: {
        ...
        rawMode: "Switch the Config tab to Form mode to edit bindings here.",
