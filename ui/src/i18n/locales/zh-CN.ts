...
export const zh_CN: TranslationMap = mergeTranslationMaps(en, {
  ...
  subtitles: {
    agents: "工作区、工具、身份。",
    home: "个人代理、聚焦与系统状态。",
    authentications: "已连接账户与运行时访问。",
    organization: "工作区系统、频道与交付健康。",
    sessions: "活动会话和默认设置。",
    automations: "唤醒与重复运行。",
    chat: "网关聊天，快速干预。",
  ...
  overview: {
    ...
    pairing: {
      hint: "此设备需要网关主机的配对批准。",
      mobileHint: "在手机上？从桌面的 Alisio 应用复制完整 URL（包括 #token=...）。",
    },
    insecure: {
    ...
    chat: {
      ...
      loadingStates: {
        connecting: {
          eyebrow: "连接中",
          title: "正在连接工作区",
          body: "在加载此聊天前，先建立运行时连接。",
        },
        bootstrap: {
          eyebrow: "Bootstrap",
          title: "正在准备聊天",
          body: "在显示会话前，先同步工作区的初始状态。",
        },
        history: {
          eyebrow: "历史记录",
          title: "正在加载会话历史",
          body: "正在获取此会话的最新消息和工具活动。",
        },
        runStart: {
          eyebrow: "Cold start",
          title: "正在启动运行",
          body: "远端运行时正在预热并准备工具执行。",
        },
      },
      attachments: {
        imageAlt: "已附加图片",
