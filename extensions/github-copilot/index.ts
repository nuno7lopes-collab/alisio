import { definePluginEntry, type ProviderAuthContext } from "alisio/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "alisio/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "alisio/plugin-sdk/provider-auth-login";
