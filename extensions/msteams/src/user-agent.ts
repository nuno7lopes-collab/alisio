...
function resolveAlisioVersion(): string {
  try {
 ...
 * and appends the Alisio version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Alisio/<alisio-version>"
 * Example: "teams.ts[apps]/2.0.5 Alisio/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Alisio/${resolveAlisioVersion()}`;
  return cachedUserAgent;
}
