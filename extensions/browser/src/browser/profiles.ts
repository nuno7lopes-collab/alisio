 ...
 *
 * Default port range: 40716-40815 (100 profiles max)
 ...
 *   40705 - Gateway WebSocket
 *   40706 - Bridge
 *   40707 - Browser control server
 *   40708-40715 - Reserved for future one-off services (canvas at 40709)
 */

export const CDP_PORT_RANGE_START = 40716;
export const CDP_PORT_RANGE_END = 40815;
...
export const PROFILE_COLORS = [
  "#FF4500", // Orange-red (alisio default)
  "#0066CC", // Blue
  "#00AA00", // Green
  "#9933FF", // Purple
  "#FF6699", // Pink
