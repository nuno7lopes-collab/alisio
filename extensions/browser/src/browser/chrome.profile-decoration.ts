 ...
 */
export function decorateAlisioProfile(
  userDataDir: string,
  opts?: { name?: string; color?: string },
) {
  const desiredName = opts?.name ?? DEFAULT_ALISIO_BROWSER_PROFILE_NAME;
  const desiredColor = (opts?.color ?? DEFAULT_ALISIO_BROWSER_COLOR).toUpperCase();
