...
vi.mock("alisio/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("alisio/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("alisio/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("alisio/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("alisio/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("alisio/plugin-sdk/webhook-ingress");
  return {
    ...actual,
