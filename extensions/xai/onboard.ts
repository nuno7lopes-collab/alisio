...
>({
  ...
  resolveParams: (_cfg: AlisioConfig, api) => ({
    providerId: "xai",
    api,
...
export function applyXaiProviderConfig(cfg: AlisioConfig): AlisioConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiResponsesApiConfig(cfg: AlisioConfig): AlisioConfig {
  return xaiPresetAppliers.applyProviderConfig(cfg, "openai-responses");
}

export function applyXaiConfig(cfg: AlisioConfig): AlisioConfig {
