...
import { mediaKindFromMime } from "alisio/plugin-sdk/media-runtime";
import { withTempDownloadPath, type AlisioConfig } from "../runtime-api.js";
...
function createConfiguredFeishuMediaClient(params: { cfg: AlisioConfig; accountId?: string }): {
...
export async function downloadImageFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "alisio-feishu-img-",
...
export async function downloadMessageResourceFeishu(params: {
  ...
  const buffer = await readFeishuResponseBuffer({
    response,
    tmpDirPrefix: "alisio-feishu-resource-",
