...
import type { ChannelMeta, ChannelPlugin, AlisioConfig } from "../runtime-api.js";
import {
...
function areAnyFeishuReactionActionsEnabled(cfg: AlisioConfig): boolean {
      ...
      config: {
        ...
        deleteAccount: ({ cfg, accountId }) => {
          ...
          if (isDefault) {
            ...
            const next = { ...cfg } as AlisioConfig;
