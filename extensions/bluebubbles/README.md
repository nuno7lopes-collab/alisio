...
This package contains the **BlueBubbles external channel plugin** for Alisio.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `alisio/plugin-sdk` helpers.
