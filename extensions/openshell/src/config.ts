...
import { buildPluginConfigSchema, type AlisioPluginConfigSchema } from "alisio/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): AlisioPluginConfigSchema {
