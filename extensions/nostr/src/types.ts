...
function resolveConfiguredDefaultNostrAccountId(cfg: AlisioConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AlisioConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AlisioConfig): string {
