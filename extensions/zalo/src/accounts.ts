...
function mergeZaloAccountConfig(cfg: AlisioConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: AlisioConfig): ResolvedZaloAccount[] {
