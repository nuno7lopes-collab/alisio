...
export function resolveTavilySearchConfig(cfg?: AlisioConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: AlisioConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: AlisioConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
