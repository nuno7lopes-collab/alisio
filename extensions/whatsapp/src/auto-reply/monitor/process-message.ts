import { resolveIdentityNamePrefix } from "alisio/plugin-sdk/agent-runtime";
import {
  resolveInboundSessionEnvelopeContext,
  toLocationContext,
} from "alisio/plugin-sdk/channel-inbound";
import { formatInboundEnvelope } from "alisio/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "alisio/plugin-sdk/channel-reply-pipeline";
import { shouldComputeCommandAuthorized } from "alisio/plugin-sdk/command-auth";
...
import { recordSessionMetaFromInbound } from "alisio/plugin-sdk/config-runtime";
import { getAgentScopedMediaLocalRoots } from "alisio/plugin-sdk/media-runtime";
import { buildHistoryContextFromEntries, type HistoryEntry } from "alisio/plugin-sdk/reply-history";
...
import type { getChildLogger } from "alisio/plugin-sdk/runtime-env";
import {
