...
export function listWhatsAppAuthDirs(cfg: AlisioConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AlisioConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AlisioConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AlisioConfig): ResolvedWhatsAppAccount[] {
