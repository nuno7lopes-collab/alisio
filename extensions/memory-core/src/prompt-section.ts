...
export const buildPromptSection: MemoryPromptSectionBuilder = ({
  ...
  if (hasMemorySearch && hasMemoryGet) {
    ...
    toolGuidance =
      "Before answering anything about prior work, decisions, dates, people, preferences, or todos: run memory_search on the configured memory roots and answer from the matching results. If low confidence after search, say you checked.";
  } else {
    toolGuidance =
