...
// Default to Alisio workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".alisio", "workspace", "media", "inbound");
 ...
 * Format matches Alisio's expected attachment structure.
 */
