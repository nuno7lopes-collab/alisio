...
export async function resolveTlonSetupConfigured(cfg: AlisioConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: AlisioConfig): Promise<string[]> {
