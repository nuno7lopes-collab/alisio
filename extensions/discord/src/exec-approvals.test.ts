...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AlisioConfig["channels"]>["discord"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AlisioConfig["channels"]>["discord"]>>,
): AlisioConfig {
  return {
    channels: {
      discord: {
