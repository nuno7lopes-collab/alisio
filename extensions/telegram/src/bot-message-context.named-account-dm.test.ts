...
let clearRuntimeConfigSnapshot: typeof import("alisio/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("alisio/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
