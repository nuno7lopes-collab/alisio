...
type ResolveConfiguredBindingRouteFn =
  typeof import("alisio/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("alisio/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("alisio/plugin-sdk/command-auth", async (importOriginal) => {
