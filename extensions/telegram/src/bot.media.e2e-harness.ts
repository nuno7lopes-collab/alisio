...
type FetchRemoteMediaFn = typeof import("alisio/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("alisio/plugin-sdk/media-runtime")>,
) {
...
vi.mock("alisio/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("alisio/plugin-sdk/agent-runtime", async (importOriginal) => {
