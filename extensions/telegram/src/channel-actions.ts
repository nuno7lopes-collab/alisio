...
} from "alisio/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "alisio/plugin-sdk/config-runtime";
import { extractToolSend } from "alisio/plugin-sdk/tool-send";
import {
