...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "ui/src/ui/views/authentications.test.ts",
      "ui/src/ui/views/capabilities.test.ts",
      "ui/src/ui/views/channels.test.ts",
      "ui/src/ui/views/chat.test.ts",
      "ui/src/ui/views/memory.test.ts",
      "ui/src/ui/views/models.test.ts",
      "ui/src/ui/views/nodes.devices.test.ts",
      "ui/src/ui/views/security.test.ts",
      "ui/src/ui/views/settings.test.ts",
      "ui/src/ui/views/setup.test.ts",
      "ui/src/ui/views/skills-grouping.test.ts",
      "ui/src/ui/views/tasks.test.ts",
      "ui/src/ui/views/usage-render-details.test.ts",
      "ui/src/ui/controllers/agents.test.ts",
      "ui/src/ui/controllers/alisio.node.test.ts",
      "ui/src/ui/controllers/agent-files.test.ts",
      "ui/src/ui/controllers/agent-memory.test.ts",
      ...
      "ui/src/ui/views/memory-graph-view.test.ts",
