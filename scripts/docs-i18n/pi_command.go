...
const (
	envDocsPiExecutable     = "ALISIO_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "ALISIO_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "ALISIO_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "alisio", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
