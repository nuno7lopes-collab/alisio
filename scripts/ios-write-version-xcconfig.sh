...
- ALISIO_GATEWAY_VERSION = exact package.json version
- ALISIO_MARKETING_VERSION = short iOS/App Store version
- ALISIO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ALISIO_GATEWAY_VERSION = ${PACKAGE_VERSION}
ALISIO_MARKETING_VERSION = ${MARKETING_VERSION}
ALISIO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
